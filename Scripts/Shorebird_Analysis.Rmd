...
#changing bird names to lower case to keep uniformity
...
#save processed datasheets in Data folder
...
# Optional: Calculate and display the mean value
mean_surveytotal <- mean(surveycounts$surveytotal, na.rm = TRUE)
cat("Overall mean survey total:", round(mean_surveytotal, 2), "\n")
```
...
# Create the "plots" folder in the root directory
output_dir <- "plots"
...
# Save the birdplotfinal_byzone plot using the specified convention
# You'll need to define these variables according to your specific case:
site_name <- "your_site_name"        # Replace with your actual site name
target_assemblage <- "bird"          # Replace with your assemblage type

# Save the plot
ggsave(filename = file.path(output_dir, paste(site_name, target_assemblage, "byzone_plot.png", sep = "_")), 
...
shorebirds_stack <- shorebirds_fixed %>%
  ...
  mutate(DataType = case_when(DataType == 'Gull' ~ 'Gull',
                              ...
                              DataType == 'Great Blue Heron' ~ 'Great Blue Heron',
